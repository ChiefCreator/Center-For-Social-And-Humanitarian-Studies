...
export default function initServiceCharts() {
  ...
  Highcharts.chart(serviceChart_02, {
    ...
    colors: ["#7fc309", "#1acb61"],
    series: [
      {
        name: "Концепция продукта",
        data: [5, 23, 68, 77, 50, 80],
      },
      {
        name: "Эффективность рекламы",
        data: [45, 52, 39, 20, 28, 35],
      },
    ],
    responsive: {
      rules: [
    ...
    series: [
      {
        ...
        data: [10, 20, 25, 30, 35, 45, 28, 50, 52, 60, 48, 54, 50],
        color: "#1c1cc7",
      },
      {
        name: "Лояльность потребителей",
        data: [5, 8, 6, 10, 15, 13, 8, 9, 16, 14, 20, 17, 10],
        color: "#1cbec7",
      },
      {
        name: "Удовлетворенность клиентов",
        data: [75, 80, 65, 58, 62, 70, 73, 68, 77, 80, 75, 85, 95],
        color: "#33c71c",
      },
    ],
    ...
    series: [
      {
        ...
        colors: ["#17d7ca", "#1727d7", "#6a17d7", "#ca17d7", "#d71717", "#d77717", "#d7cd17"],
      },
    ],
  ...
  Highcharts.chart(serviceChart_06, {
    ...
    series: [
      {
        name: "Профориентация",
        data: [70, 75, 80, 65, 70, 70, 64, 69, 80, 82, 84, 78, 75],
        color: "#1c1cc7",
      },
      {
        name: "Восприятие рекламы",
        data: [30, 40, 60, 75, 70, 50, 80, 73, 83, 55, 60, 43, 36],
        color: "#1cbec7",
      },
      {
        name: "Командообразование",
        data: [80, 75, 70, 82, 70, 60, 50, 35, 43, 32, 30, 23, 15],
        color: "#33c71c",
      },
    ],
